              ...
              <div className="md:col-span-3 space-y-1">
                ...
                <div className="flex items-center gap-1.5">
                  <input
                    ...
                    min={1}
                    max={60}
                    value={editedMinFrequencyMinutes}
                    onChange={(e) => setEditedMinFrequencyMinutes(parseInt(e.target.value) || 1)}
                    className="w-full bg-slate-950 border border-slate-700 rounded-lg px-2.5 py-1.5 text-xs text-white font-mono text-center font-bold"
                  />
          ...
          <div className="md:col-span-3 space-y-1">
            ...
            <div className="flex items-center gap-1.5">
              <input
                ...
                min={1}
                max={60}
                value={minFrequencyMinutes}
                onChange={(e) => setMinFrequencyMinutes(parseInt(e.target.value) || 1)}
                className="w-full bg-slate-950 border border-slate-700 rounded-xl px-3 py-2 text-xs text-white font-mono text-center font-bold"
              />
              <span className="text-xs text-slate-400 font-bold">m</span>
            </div>
          </div>
